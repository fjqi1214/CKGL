...
namespace DAL
{
    public class StorageLocationCollection : IEnumerable<StorageLocation>,
        ISplitePageQuery<StorageLocation>
    {
        ...
        public StorageLocationCollection()
        {
            ...
            storageLocations.Add(new StorageLocation { ProductName = "13", LocationName = "位置12", ManufacturerName = "厂家12" });
            storageLocations.Add(new StorageLocation { ProductName = "14", LocationName = "位置12", ManufacturerName = "厂家12" });
            storageLocations.Add(new StorageLocation { ProductName = "15", LocationName = "位置12", ManufacturerName = "厂家12" });
            storageLocations.Add(new StorageLocation { ProductName = "16", LocationName = "位置12", ManufacturerName = "厂家12" });
            storageLocations.Add(new StorageLocation { ProductName = "17", LocationName = "位置12", ManufacturerName = "厂家12" });
            storageLocations.Add(new StorageLocation { ProductName = "18", LocationName = "位置12", ManufacturerName = "厂家12" });
            storageLocations.Add(new StorageLocation { ProductName = "19", LocationName = "位置12", ManufacturerName = "厂家12" });
            storageLocations.Add(new StorageLocation { ProductName = "20", LocationName = "位置12", ManufacturerName = "厂家12" });
            storageLocations.Add(new StorageLocation { ProductName = "21", LocationName = "位置12", ManufacturerName = "厂家12" });
            storageLocations.Add(new StorageLocation { ProductName = "22", LocationName = "位置12", ManufacturerName = "厂家12" });
